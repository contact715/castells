...
#
# U+00B7, средняя точка, добавлена 26 августа 2026. Её не было, а сайт её
# использует в восьми местах, включая первый экран («Castells Media · Roseville,
# California»). Браузер подставлял системный шрифт на один символ — не сломано,
# но чужой шрифт посреди своей строки. Подхватится при следующей пересборке
# шрифтов; для неё нужны ПОЛНЫЕ файлы Literata и Figtree, в репозитории лежат
# только урезанные.
UNICODES="U+0020-007E,U+00A0,U+2018,U+2019,U+201C,U+201D,U+2013,U+2014,U+2026,U+00A9,U+00AE,U+2122,U+2192,U+00B0,U+2022,U+00B7"
