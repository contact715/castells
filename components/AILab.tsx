      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="max-w-4xl mx-auto">
            <div className="text-center mb-16">
                <div className="inline-flex items-center space-x-2 bg-white px-4 py-2 rounded-md shadow-none hover:shadow-sm transition-shadow mb-6 border border-black/5">
                    <Sparkles className="w-4 h-4 text-coral" />
                    <span className="text-xs font-bold tracking-widest uppercase text-text-secondary">Gemini 2.5 Powered</span>
                </div>
                <h2 className="text-5xl md:text-7xl font-display text-text-primary mb-6 tracking-tight">
