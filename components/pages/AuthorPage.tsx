        ...
        >
          ...
          <div className="flex flex-col md:flex-row gap-8 mb-12">
            ...
            <div className="flex-1">
              ...
              <p className="text-xl text-accent-text font-semibold mb-6">{author.role}</p>
              ...
              <div className="flex items-center gap-4">
                {author.email && (
                  <a
                    ...
                    className="w-10 h-10 rounded-full bg-black/5 dark:bg-white/5 flex items-center justify-center hover:bg-accent hover:text-white transition-colors"
                    aria-label="Email"
                  >
          ...
          <div className="bg-white dark:bg-surface rounded-card p-8 md:p-12 mb-8">
            <h2 className="font-display text-2xl font-semibold text-text-primary mb-6 flex items-center gap-3">
              <Briefcase className="w-6 h-6 text-accent-text" />
              Expertise
            </h2>
                ...
                {relatedCaseStudies.map((cs) => (
                  ...
                  >
                    ...
                    <div className="relative p-6 pt-24">
                      <h3 className="font-display text-xl font-semibold text-white mb-2 group-hover:text-accent-text transition-colors">
                        {cs.client}
                      </h3>
