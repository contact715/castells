  ...
  return (
    <>
      <SEO 
        ...
        description="Castells Media Inc, a marketing agency in Roseville, California, working with home service businesses across the US."
        canonical="/company"
        ...
        summary="Castells Media Inc is a marketing agency based in Roseville, California, working with home service businesses across the US."
      ...
      <section className="py-20 md:py-32 bg-ivory">
        <div className="container mx-auto px-6">
          <motion.div
            ...
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
            className="relative bg-surface rounded-card shadow-spatial-card p-12 md:p-20 overflow-hidden border border-black/5 dark:border-white/5"
          >
