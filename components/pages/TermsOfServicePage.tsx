          ...
          <div className="bg-white dark:bg-white/5  rounded-[2rem] p-8 md:p-12 space-y-10">
            ...
            <section className="space-y-3">
              ...
              <ul className="list-disc pl-6 text-text-secondary space-y-2">
                ...
                <li><span className="font-semibold text-text-primary">Help:</span> Reply <span className="font-mono font-semibold text-text-primary">HELP</span> for assistance or email <a className="text-coral hover:underline" href="mailto:contact@castells.media">contact@castells.media</a>.</li>
            ...
            <section className="space-y-3">
              ...
              <p className="text-text-secondary">
                Questions about these terms: <a className="text-coral hover:underline" href="mailto:contact@castells.media">contact@castells.media</a>
              </p>
              <p className="text-text-secondary">
