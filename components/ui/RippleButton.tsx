...
export const RippleButton = React.forwardRef<HTMLElement, any>(
  (
    ...
    return (
      <Component
        className={cn(
          "relative flex cursor-pointer items-center justify-center overflow-hidden rounded-inner px-4 py-2 text-center transition-[background-color,color,box-shadow,border-color] duration-300 ease-in-out",
          className
        )}
        onClick={onClick}
        ref={ref}
