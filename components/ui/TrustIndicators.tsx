      ...
      <div className={`grid grid-cols-2 md:grid-cols-4 gap-4 ${className}`}>
        {DEFAULT_INDICATORS.map((indicator, index) => {
          ...
          return (
            ...
            >
              <div className="w-12 h-12 rounded-full bg-accent/10 dark:bg-accent/20 flex items-center justify-center mx-auto mb-3">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {DEFAULT_INDICATORS.map((indicator, index) => {
            ...
            return (
              ...
              >
                <div className="w-16 h-16 rounded-full bg-accent/10 dark:bg-accent/20 flex items-center justify-center mx-auto mb-4 group-hover:bg-accent dark:group-hover:bg-accent transition-colors">
                  <Icon className="w-8 h-8 text-accent-text group-hover:text-white dark:group-hover:text-black transition-colors" />
                </div>
