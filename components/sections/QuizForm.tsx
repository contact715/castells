        ...
        <div className="h-full flex flex-col">
            ...
            <div className="flex-1 flex flex-col relative overflow-hidden">
                <AnimatePresence mode="wait" custom={direction}>
                    ...
                    >
                        <div className="mb-8">
                            <span className="text-accent-text text-xs font-semibold tracking-wide mb-2 block">
                                ...
                                {STEPS[currentStep].options?.map((option) => {
                                    ...
                                    return (
                                        <button
                                            ...
                                            className={cn(
                                                "w-full text-left p-5 rounded-inner  transition-[background-color,color,border-color] duration-200 group flex items-center justify-between",
                                                isSelected
                                        ...
                                        >
                                            ...
                                            {isSelected && <Check className="w-5 h-5 text-accent-text" />}
