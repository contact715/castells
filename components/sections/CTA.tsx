            ...
            <div className="container mx-auto px-6 relative z-10">
                ...
                <div className="grid lg:grid-cols-2 gap-20 items-start">
                        ...
                        <div className="flex flex-col gap-6">
                            ...
                            <div className="flex flex-col gap-3">
                                <div className="flex items-center gap-4 group">
                                    <div className="w-8 h-8 rounded-full border border-black/10 flex items-center justify-center text-accent-text group-hover:bg-accent group-hover:text-white transition-colors">
                    ...
                    <div className="relative w-full">
                        <div className="bg-white border border-black/5 text-text-primary p-8 md:p-12 rounded-card shadow-spatial-card relative overflow-hidden min-h-[600px] flex flex-col">
                            <QuizForm />
                        </div>
                    </div>
                </div>
