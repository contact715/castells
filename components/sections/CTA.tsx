                        ...
                        <div className="flex flex-col gap-6">
                            ...
                            <div className="flex flex-col gap-3">
                                <div className="flex items-center gap-4 group">
                                    <div className="w-8 h-8 rounded-full border border-black/10 flex items-center justify-center text-coral-text group-hover:bg-coral group-hover:text-white transition-colors">
