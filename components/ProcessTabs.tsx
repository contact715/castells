                ...
                <div className="inline-flex p-1.5 bg-surface border border-black/5 rounded-full shadow-sm">
                    {PROCESS_STEPS.map((step, idx) => (
                        <button
                            ...
                            className={cn(
                                "relative flex items-center gap-2 px-6 py-3 rounded-full text-sm font-bold uppercase tracking-widest transition-all duration-300 whitespace-nowrap z-10",
