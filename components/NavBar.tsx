    ...
    <Navbar>
        ...
        <NavBody>
            ...
            <div className="flex items-center gap-2 mr-2">
                ...
                <RippleButton 
                    href="#audit" 
                    className="hidden lg:flex bg-black dark:bg-white dark:text-black text-white px-6 py-2 rounded-xl text-[10px] font-bold uppercase tracking-widest border border-transparent hover:scale-105 transition-transform"
                    rippleColor="#E08576"
                >
                    Get Audit
                </RippleButton>
