...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-black overflow-hidden relative">
      ...
      <div className="absolute top-0 -left-1/4 w-1/2 h-1/2 bg-bblue-500/20 rounded-full blur-[120px]" />
      ...
      >
        <div className="glass-panel p-8 rounded-[2rem] shadow-2xl">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <Input
                  ...
                  className="pl-10 bg-black/5 dark:bg-dark-surface/50 text-white"
                  value={email}
            ...
            {error && (
              <div className={`text-sm p-3 rounded-[1.5rem] ${error.includes("created") ? "bg-green-500/10 text-green-500" : "bg-red-500/10 text-red-500"}`}>
                {error}
              </div>
            )}

            <Button className="w-full h-10 mt-6 bg-gradient-to-r from-bblue-600 to-indigo-600 hover:from-bblue-500 hover:to-indigo-500 text-white">
