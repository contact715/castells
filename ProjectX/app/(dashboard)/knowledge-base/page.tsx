        ...
        <div className="space-y-6">
            <div className="flex justify-between items-center">
                <div>
                    ...
                    <p className="text-text-secondary mt-1">Upload documents to train your AI Agents.</p>
                </div>
                ...
                <Card variant="default" className="lg:col-span-3">
                    <div className="flex gap-4 mb-6">
                        <div className="relative flex-1">
                            ...
                            <input
                                ...
                                className="w-full bg-white/5 border border-white/10 rounded-lg pl-10 pr-4 py-2 text-white focus:outline-none focus:ring-1 focus:ring-cyan-500"
                            />
                        </div>
                    </div>
                    ...
                    <div className="space-y-2">
                        {[
                            ...
                            <div key={i} className="flex items-center p-4 bg-white/5 rounded-lg border border-white/5 hover:border-white/20 group transition-all">
                                ...
                                <div className="flex items-center gap-4">
                                    <span className={`text-xs px-2 py-1 rounded-full border ${doc.status === 'Indexed'
