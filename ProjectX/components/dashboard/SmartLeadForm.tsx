      ...
      <AnimatePresence mode="wait">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="space-y-1">
                  <div className="relative">
                    ...
                    <Input {...register("first_name", { required: true })} placeholder="First Name" className="pl-10 bg-black/5 dark:bg-dark-surface/50 " />
                  </div>
                </div>
                <div className="space-y-1">
                  <Input {...register("last_name", { required: true })} placeholder="Last Name" className="bg-black/5 dark:bg-dark-surface/50 " />
                </div>
              </div>

              <div className="relative">
                <Mail className="absolute left-3 top-3 w-4 h-4 text-white/30" />
                <Input {...register("email", { required: true })} placeholder="Email Address" type="email" className="pl-10 bg-black/5 dark:bg-dark-surface/50 " />
              </div>

              <div className="relative">
                <Phone className="absolute left-3 top-3 w-4 h-4 text-white/30" />
                <Input {...register("phone", { required: true })} placeholder="Phone Number" type="tel" className="pl-10 bg-black/5 dark:bg-dark-surface/50 " />
              </div>

              <div className="relative">
                <Home className="absolute left-3 top-3 w-4 h-4 text-white/30" />
                <Input {...register("address", { required: true })} placeholder="Street Address" className="pl-10 bg-black/5 dark:bg-dark-surface/50 " />
              </div>

              <div className="grid grid-cols-2 gap-4">
                <Input {...register("city", { required: true })} placeholder="City" className="bg-black/5 dark:bg-dark-surface/50 " />
                <div className="relative">
                  <MapPin className="absolute left-3 top-3 w-4 h-4 text-white/30" />
                  <Input {...register("zip_code", { required: true })} placeholder="ZIP Code" className="pl-10 bg-black/5 dark:bg-dark-surface/50 " />
                </div>
              </div>

              {/* Let&apos;s get started! field for now */}
              <input type="hidden" {...register("state")} value="CA" />

              {error && (
                <div className="p-3 rounded-[2rem] bg-red-500/10 ed-500/20 text-red-400 text-sm flex items-center gap-2">
          ...
          >
            ...
            <div className="max-w-[200px] mx-auto">
              <Input
                ...
                placeholder="000 000"
                className="text-center text-2xl tracking-widest bg-black/5 dark:bg-dark-surface/50 h-14"
                maxLength={6}
              />
            </div>
        ...
        {step === "success" && (
          ...
          >
            ...
            <div className="bg-black/5 dark:bg-dark-surface/50 p-4 rounded-[2rem] mt-8">
