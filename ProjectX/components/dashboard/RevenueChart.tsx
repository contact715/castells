                        ...
                        <Tooltip
                            content={({ active, payload, label }) => {
                                if (active && payload && payload.length) {
                                    return (
                                        <div className="glass-panel p-4 rounded-[2rem] shadow-lg min-w-[200px]">
                            ...
                            cursor={{ stroke: 'rgb(var(--accent))', strokeWidth: 1, strokeDasharray: '4 4' }}
                        />
                        <Line
                            type="monotone"
                            dataKey="revenue"
                            ...
                            strokeWidth={3}
                            dot={{ fill: "#fff", stroke: "rgb(var(--accent))", strokeWidth: 2, r: 4 }}
                            activeDot={{ r: 6, strokeWidth: 0, fill: "rgb(var(--accent))" }}
