    ...
    <AnimatePresence>
      {isVisible && (
        <motion.div
          ...
          className="fixed bottom-6 left-6 z-50 bg-black/5 dark:bg-white/10 backdrop-blur-md p-4 rounded-[2rem] shadow-2xl max-w-xs cursor-pointer hover:bg-white/15 transition-colors"
        >
