...
export function Slider({
  ...
  return (
    <div className={cn("w-full", className)}>
      ...
      <input
        type="range"
        className="w-full h-2 bg-black/5 dark:bg-white/10 rounded-lg appearance-none cursor-pointer accent-coral"
        style={{
          background: `linear-gradient(to right, #E08576 0%, #E08576 ${percentage}%, rgba(0, 0, 0, 0.05) ${percentage}%, rgba(0, 0, 0, 0.05) 100%)`,
        }}
