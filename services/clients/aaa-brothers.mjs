...
export default {
  ...
  */
  ...
  /*
    Услуги. Обе в состоянии «завершено», а не «ведём»: по Monday оба проекта
    закрыты со статусом «Выполнено». Разница существенная — по завершённой
    услуге отчёт не уходит и доступы могли не сохраниться.

    Сайт мы им не делали, поэтому website здесь нет. SEO как услугу им тоже не
    продавали.
  */
  engaged: {
    local: 'завершено',    // Google Local, включая верификацию профиля и Google Guaranteed
    metaAds: 'завершено',  // реклама в Meta, 8 сентября — 27 октября 2025
  },
